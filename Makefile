...
# 
ELF := StereoSystem.elf

# Paths to C, C++, and assembly source files.
C_SRCS += Colder.c
C_SRCS += Command.c
C_SRCS += Database.c
C_SRCS += ISR_vectors.c
C_SRCS += Packet.c
C_SRCS += Playlist.c
C_SRCS += Queue.c
C_SRCS += RS232.c
C_SRCS += StereoSystem.c
C_SRCS += CommandScheduler.c
C_SRCS += Song.c
C_SRCS += sound/AudioDeviceController.c
C_SRCS += sound/Sound.c
C_SRCS += sound/SoundMixer.c
C_SRCS += PushKeyController.c
C_SRCS += Graphic.c
C_SRCS += Cursor.c
C_SRCS += MemoryMgr.c
C_SRCS += Object.c
...
C_SRCS += Frame.c
C_SRCS += libMAD/bit.c
C_SRCS += libMAD/decoder.c
C_SRCS += libMAD/frame.c
C_SRCS += libMAD/huffman.c
C_SRCS += libMAD/layer12.c
C_SRCS += libMAD/layer3.c
C_SRCS += libMAD/stream.c
C_SRCS += libMAD/synth.c
C_SRCS += libMAD/timer.c
C_SRCS += sound/AudioFormat.c
C_SRCS += DSP/PhaseVocoder.c
C_SRCS += DSP/fft.c
C_SRCS += TestBot.c
CXX_SRCS :=
ASM_SRCS :=
